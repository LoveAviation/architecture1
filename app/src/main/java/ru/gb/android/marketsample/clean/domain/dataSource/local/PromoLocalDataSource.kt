package ru.gb.android.marketsample.clean.domain.dataSource.local
...
class PromoLocalDataSource(
    ...
    fun consumeProducts(): Flow<List<PromoEntity>> = dataStore.data
    ...
    private companion object {
        const val PRODUCT_KEY = "layered_promo_key"
    }
}